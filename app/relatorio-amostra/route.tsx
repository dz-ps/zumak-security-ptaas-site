...
export async function GET(){
  const doc = (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.p}>Sumário executivo: este documento demonstra o formato do relatório entregue, incluindo matriz de risco e tabela de achados.</Text>
  ...
  return new NextResponse(buffer as any, { headers: { "Content-Type":"application/pdf", "Content-Disposition":"attachment; filename=relatorio-amostra.pdf" } })
}
